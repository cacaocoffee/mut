...
| Wave | 무엇 | 이슈 | 완료 | 병렬 |
|---|---|---|---|---|
| 0 | 스펙 정합 · 스캐폴딩 · 계약 | 6 | **2** (A00 · 000) | 1~2 |
| 1 | 인증·권한 | 3 | 0 | 2 |
| 2 | 도메인 코어 | 5 | 0 | 2 |
| 3 | 발행 | 5 | 0 | 2 |
| 4 | 조회 API | 7 | 0 | **4** |
...
| [000](ISSUE-000.md) | `apps/api` Gradle 스캐폴딩 (Kotlin·Spring Boot 3.x) | infra | **DONE** | A00 | `PRIN-T01` SPEC-05 §2 |
| [001](ISSUE-001.md) | 모듈 경계 테스트 | infra | **IN_PROGRESS** | 000 | `PRIN-T03` |
