...
import kr.kcocktail.search.list.AllOf
...
object FacetSql {
    ...
    fun abvBands(filter: CocktailFilter): Sql {
        val where = CocktailListSql.where(filter)
        val cases = kr.kcocktail.search.list.AbvBand.entries.joinToString("\n                   ") {
...
@Suppress("unused")
internal fun CocktailFilter.plusFlavor(tag: kr.kcocktail.common.taxonomy.FlavorKey) =
