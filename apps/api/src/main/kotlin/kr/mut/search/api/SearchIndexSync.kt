 ...
 * 각 도메인은 [kr.mut.cocktail.api.CocktailPublished] 같은 **사건만 알리고**,
 * [kr.mut.search.index.SearchIndexListener] 가 구독해 여기를 부른다.
 *
 ...
 *   ([kr.mut.cocktail.api.CocktailRenamed]) 발행 상태는 그대로여야 한다.
 *   새 행이면 `false` 로 들어간다.
 */
