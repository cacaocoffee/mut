package kr.mut.admin.task

import com.fasterxml.jackson.databind.ObjectMapper
import kr.mut.admin.verification.TaskType
 ...
 * ## JPA 엔티티를 두지 않는다
 *
 * `verification_task` 는 배치가 SQL 로 upsert 하는 테이블이다 ([kr.mut.admin.verification.VerificationTaskStore]).
