...
class LocationAbsenceTest {
    ...
    fun `RED20,21 - 이벤트 payload 스키마에 좌표 자리가 없다`() {
        val leaky = kr.mut.common.analytics.EventType.entries
        ...
        assertAll(
            ...
            },
            {
                ...
                assertThat(kr.mut.common.analytics.EventType.entries).isNotEmpty()
            },
            {
    ...
    companion object {
        private const val SOURCE_PATH =
            "src/test/kotlin/kr/mut/architecture/LocationAbsenceTest.kt"
